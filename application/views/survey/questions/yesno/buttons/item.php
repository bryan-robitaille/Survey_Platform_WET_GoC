...
<div class="list-unstyled answers-list radio-list">
    ...
    <div class='col-xs-12 col-sm-6'>  <!-- Full width on Phone; otherwise half width -->
      <div class="btn-group btn-group-justified" data-toggle="buttons" id="<?php echo $name;?>-container">
        ...
        <!-- Yes -->
        <label class="btn btn-default <?php if($yChecked){ echo "active";}?>"  id="label-answer<?php echo $name;?>Y">
          <input
              class="radio"
              type="radio"
              name="<?php echo $name;?>"
        ...
        <!-- No -->
        <label class="btn btn-default <?php if($nChecked){ echo "active";}?>"  id="label-answer<?php echo $name;?>N">
            <input
                class="radio"
                type="radio"
                name="<?php echo $name;?>"
        ...
        <!-- No answer -->
        <?php if($noAnswer):?>
            <label class="btn btn-default <?php if($naChecked){ echo "active";}?>" id="label-answer<?php echo $name;?>">
